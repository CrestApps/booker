...
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            <div class="btn-group btn-group-sm" role="group">
                <a href="{{ route('reservation_pickups.reservation_pickup.index') }}" class="btn btn-primary" title="{{ trans('reservations.show_all_scheduled_reservations') }}">
    ...
    <div class="panel-body">
        ...
        <fieldset>
            ...
            <form method="POST" action="{{ route('reservation_pickups.reservation_pickup.process', $reservation->id) }}" accept-charset="UTF-8" id="pickup_reservation_form" name="pickup_reservation_form" class="form-horizontal">
                {{ csrf_field() }}
                                        ...
                                        <div class="row mt-5 mb-5">
                                            ...
                                            <div class="col-md-4 pl-10 pr-5">
                                                <select class="form-control payment-method" name="payments[0][method]" required>
                                                    ...
                                                    <option value="credit">{{ trans('reservations.credit') }}</option>
                                                </select>
                                            </div>
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('reservations.process_pickup') }}">
                    </div>
                </div>
