...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('expense_categories.expense_category.update', $expenseCategory->id) }}" id="edit_expense_category_form" name="edit_expense_category_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @include ('expense_categories.form', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('expense_categories.update') }}">
                    </div>
                </div>
            </form>
