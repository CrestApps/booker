...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ trans('reservations.dropoff') }}</h4>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group btn-group-sm pull-right" role="group">
                                    ...
                                    <a href="{{ route('reservation_dropoffs.reservation_dropoff.dropoff', $reservation->id ) }}" class="btn btn-primary" title="{{ trans('reservations.pickup') }}">
                                        <span class="glyphicon glyphicon-home" aria-hidden="true"></span> {{ trans('reservations.show_dropoff') }}
                                    </a>
